...
#                        Last Modified : Mo 13 Apr 2020 19:44:41 CEST
...
su - "${USERNAME}" -c "/home/${USERNAME}/.fzf/install --key-bindings --completion --update-rc" &> /dev/null || echo "[error] Could not install fzf"
